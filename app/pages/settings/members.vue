...
<template>
  <div class="flex flex-col gap-6">
    <UPageCard description="Manage organization membership." orientation="horizontal" title="Members" variant="naked">
      <UButton class="w-fit lg:ms-auto" icon="i-lucide-user-plus" label="Add Member" @click="showAdd = true" />
    </UPageCard>
      ...
      <UTable :columns="columns" :data="members || []">
        ...
        <template #actions-cell="{ row }">
          <div class="flex items-center gap-1">
            <UButton :label="row.original.is_admin ? 'Demote' : 'Promote'" size="xs" variant="ghost" @click="toggleAdmin(row.original)" />
