        ...
        <div v-else-if="aiApp" class="w-full min-w-0 p-6 pb-28">
          <UForm ref="orchestratorEditFormRef" :schema="schema" :state="{ name, tier, whoami }" @submit="onSubmit">
            ...
            <div class="pointer-events-none sticky bottom-0 z-10 -mx-6 mt-4 flex justify-end px-6 pt-4 pb-6">
              <div
                class="border-accented bg-default/95 supports-backdrop-filter:bg-default/80 pointer-events-auto inline-flex max-w-[min(100%,42rem)] flex-wrap items-center justify-end gap-2 rounded-3xl border border-dotted px-4 py-3 shadow-lg backdrop-blur"
              >
                <UButton
                  color="neutral"
